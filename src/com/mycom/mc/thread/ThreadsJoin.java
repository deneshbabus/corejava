    ...
    public static void main(String[] args) throws InterruptedException
    {
        ...
        final Thread t1 = new Thread()
        {
            ...
            public void run()
            {
                ...
                for(int i = 0; i <= 1000; i++)
                {
                    ...
                    this.notify();
                    /*this will sleep ..so some other waiting/join thread get change to execution
                     * try {
						Thread.sleep(1000);
        ...
        final Thread t2 = new Thread()
        {
            ...
            public void run()
            {
                ...
                try
                {
                    t1.join(10000, 500000);   //waits at most 5.5 seconds for thread t1 to finish it's task
                }
                catch (InterruptedException e)
                {
                    e.printStackTrace();
